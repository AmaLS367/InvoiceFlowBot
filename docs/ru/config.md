...
| `MINDEE_API_KEY` | Ключ Mindee API для распознавания счетов | Строка из кабинета Mindee | отсутствует |
| `Model_id_mindee` | Идентификатор пользовательской или стандартной модели Mindee | Строка вида `invoice` или UUID модели | отсутствует |
